...
```mermaid
flowchart TD
    P1["Phase 1 — Fundamentals\nMath · Python · SQL · Git · BI"] --> P2
    P2["Phase 2 — Data Engineering\nPipelines · ETL · Spark · Cloud"] --> P3
    P3["Phase 3 — Data Analysis\nNumPy · Pandas · Visualization · Stats"] --> P4
    P4["Phase 4 — Machine Learning\nScikit-learn · XGBoost · Models"] --> P5
    P5["Phase 5 — Deep Learning\nPyTorch · CNNs · RNNs · Optimization"] --> P6
    P5 --> P7
    P6["Phase 6 — NLP\nTransformers · BERT · LLMs"] --> P9
    P7["Phase 7 — Computer Vision\nOpenCV · YOLO · Detection · Segmentation"] --> P8
    P8["Phase 8 — Physical AI & Robotics\nROS2 · Gazebo · LeRobot · Control"] --> P10
    P9["Phase 9 — ICT Automation\nAgents · RAG · FastAPI · Ollama"] --> P10
    P10["Phase 10 — Capstone Projects\nEnterprise End-to-End"] --> P11
    P11["Phase 11 — Interview Prep\nDS · ML · System Design"]

    style P8 fill:#1a6b3a,color:#fff
    style P9 fill:#1a3b6b,color:#fff
    style P10 fill:#6b1a6b,color:#fff
    style P11 fill:#6b3a1a,color:#fff
```
